...
export const tw = {
  ...
  // Gray background aliases
  'bg-gray-50': { backgroundColor: colors.dark[50] },
  'bg-gray-100': { backgroundColor: colors.dark[100] },
  'bg-gray-200': { backgroundColor: colors.dark[200] },
  'bg-gray-300': { backgroundColor: colors.dark[300] },
  'bg-gray-400': { backgroundColor: colors.dark[400] },
  'bg-gray-500': { backgroundColor: colors.dark[500] },
  'bg-gray-600': { backgroundColor: colors.dark[600] },
  'bg-gray-700': { backgroundColor: colors.dark[700] },
  'bg-gray-800': { backgroundColor: colors.dark[800] },
  'bg-gray-900': { backgroundColor: colors.dark[900] },
  'bg-gray-950': { backgroundColor: colors.dark[950] },
  ...
  'bg-purple-500/20': { backgroundColor: 'rgba(139, 92, 246, 0.2)' },
  'bg-primary-500/20': { backgroundColor: 'rgba(59, 130, 246, 0.2)' },
  'bg-primary-500/30': { backgroundColor: 'rgba(59, 130, 246, 0.3)' },
  ...
  // Gray aliases (mapped to dark colors for consistency)
  'text-gray-50': { color: colors.dark[50] },
  'text-gray-100': { color: colors.dark[100] },
  'text-gray-200': { color: colors.dark[200] },
  'text-gray-300': { color: colors.dark[300] },
  'text-gray-400': { color: colors.dark[400] },
  'text-gray-500': { color: colors.dark[500] },
  'text-gray-600': { color: colors.dark[600] },
  'text-gray-700': { color: colors.dark[700] },
  'text-gray-800': { color: colors.dark[800] },
  'text-gray-900': { color: colors.dark[900] },
  'text-gray-950': { color: colors.dark[950] },
  // Color aliases
